...
## Purpose
Provides Google OAuth 2.0 authentication for Workita, enabling users to sign in with their Google account, persist their session in Postgres, and have anonymous session data merged into their authenticated account on first sign-in.
